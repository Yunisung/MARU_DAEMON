...
public class GalaxiaDiffDownloadDAO extends DAO{
	...
	public SharedMap<String,Object> getDiffUploadData(String vanTrxId){
		if(vanTrxId == null){
			return new SharedMap<String,Object>();
		} else {
				...
				if(map.getString("resultCd").equals("00")) {
					...
					if(map.getString("cardType").equals("1")) {
						...
						switch(map.getString("mchtType")) {
							...
							case "중소1":diffRate = orgFeeMap.getDouble("diff1Rate");stlDiffAgencyRate = mchtMngMap.getDouble("diff1AgencyRate");stlDiffDistRate = mchtMngMap.getDouble("diff1DistRate");stlDiffSalesRate = mchtMngMap.getDouble("diff1SalesRate");break;
							case "중소2":diffRate = orgFeeMap.getDouble("diff2Rate");stlDiffAgencyRate = mchtMngMap.getDouble("diff2AgencyRate");stlDiffDistRate = mchtMngMap.getDouble("diff2DistRate");stlDiffSalesRate = mchtMngMap.getDouble("diff2SalesRate");break;
							case "중소3":diffRate = orgFeeMap.getDouble("diff3Rate");stlDiffAgencyRate = mchtMngMap.getDouble("diff3AgencyRate");stlDiffDistRate = mchtMngMap.getDouble("diff3DistRate");stlDiffSalesRate = mchtMngMap.getDouble("diff3SalesRate");break;
							default :stlDiffAgencyRate = 0;stlDiffDistRate = 0;break;
						}
