 ...
 *
 */
public class KcpDiffUploadDAO extends DAO{

	private static Logger logger = LoggerFactory.getLogger( com.pgmate.dm.dao.KcpDiffUploadDAO.class );

	public KcpDiffUploadDAO() {
	}
