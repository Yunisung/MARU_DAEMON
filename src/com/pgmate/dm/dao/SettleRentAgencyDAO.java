 ...
 *
 */
public class SettleRentAgencyDAO extends SettleRentDAO implements ImplRentSettle {

	private static Logger logger = LoggerFactory.getLogger( SettleRentAgencyDAO.class );

	public SettleRentAgencyDAO() {
